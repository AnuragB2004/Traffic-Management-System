    ...
    int recOfVeh_2()
    {
        ...
        if (file.is_open())
        {
            ...
            if (countwords > 0)
            {
                ...
                int choice;
                cout << endl
                     << "Enter 1 to go to home screen and enter 2 for again entering the registration number ";
                cin >> choice;
    ...
    int recOfVeh_3()
    {
        ...
        if (file.is_open())
        {
            ...
            if (countwords > 0)
            {
                ...
                int choice;
                cout << endl
                     << "Enter 1 to go to home screen and enter 2 for again entering the Name of the Owner";
                cin >> choice;
                if (choice == 1)
                    welcome();
                else
